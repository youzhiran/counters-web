      ...
      <div class="container-apple">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div class="animate-on-scroll">
            <h2 class="text-responsive-md font-bold text-gray-900 mb-6">
              专业的计分系统
            </h2>
            <div class="space-y-6">
              <FeatureItem
                icon="🎯"
                title="多种游戏模板支持"
                description="内置扑克牌、斗地主、麻将、计数器等多种游戏模板，满足不同桌游需求"
              />
              <FeatureItem
                icon="⚙️"
                title="自定义计分规则"
                description="灵活设置目标分数、底分、倍率等参数，适应各种游戏规则"
              />
              <FeatureItem
                icon="⚡"
                title="实时得分计算"
                description="快速输入分数，自动计算总分和排名，支持负分和小数计分"
              />
              <FeatureItem
                icon="📚"
                title="历史记录管理"
                description="完整保存每局游戏记录，支持查看、分析和数据导出"
              />
            </div>
          </div>
          <div class="animate-on-scroll">
          ...
          <div class="order-1 lg:order-2 animate-on-scroll">
            ...
            <div class="space-y-6">
              <FeatureItem
                icon="🏠"
                title="主机/客户端模式"
                description="一台设备作为主机控制计分，其他设备作为客户端实时查看"
              />
              <FeatureItem
                icon="🔄"
                title="实时数据同步"
                description="所有连接设备同步显示最新得分，确保信息一致性"
              />
              <FeatureItem
                icon="🔗"
                title="断线重连机制"
                description="网络中断后自动重连，保证游戏连续性"
              />
              <FeatureItem
                icon="📱"
                title="多设备支持"
                description="支持手机、平板、电脑等不同设备混合连接"
              />
            </div>
          </div>
        </div>
          ...
          <div class="animate-on-scroll">
            ...
            <div class="space-y-6">
              <FeatureItem
                icon="📱"
                title="响应式设计"
                description="完美适配手机、平板、电脑等不同屏幕尺寸"
              />
              <FeatureItem
                icon="🖥️"
                title="桌面/移动端适配"
                description="智能切换界面布局，提供最佳操作体验"
              />
              <FeatureItem
                icon="🎨"
                title="主题字体自定义"
                description="多种颜色主题和字体选择，个性化定制界面"
              />
              <FeatureItem
                icon="✨"
                title="流畅动画效果"
                description="精心设计的过渡动画，提升操作流畅度"
              />
            </div>
          </div>
          <div class="animate-on-scroll">
    ...
    <section class="py-20 bg-gray-50">
      <div class="container-apple">
        <div class="text-center mb-16 animate-on-scroll">
          <h2 class="text-responsive-md font-bold text-gray-900 mb-4">
            完善的数据管理
          </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <FeatureCard
            icon="🗄️"
            title="SQLite本地存储"
            description="使用SQLite数据库安全存储所有游戏数据"
            class="animate-on-scroll"
          />
          <FeatureCard
            icon="📤"
            title="数据导入导出"
            description="支持数据备份和恢复，防止数据丢失"
            class="animate-on-scroll"
          />
          <FeatureCard
            icon="🔄"
            title="备份恢复功能"
            description="一键备份游戏数据，轻松迁移到新设备"
            class="animate-on-scroll"
          />
          <FeatureCard
            icon="🔒"
            title="隐私保护"
            description="所有数据本地存储，保护用户隐私安全"
            class="animate-on-scroll"
          />
        </div>
      </div>
