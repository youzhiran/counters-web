        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div class="text-center animate-on-scroll">
              ...
              <h3 class="text-lg font-semibold text-gray-900 mb-2">正式版 (rc)</h3>
              <p class="text-gray-600 text-sm">稳定可靠，推荐日常使用</p>
            </div>
            ...
            <div class="text-center animate-on-scroll">
              ...
              <p class="text-gray-600 text-sm">新功能预览，可能存在问题</p>
            </div>
            ...
            <div class="text-center animate-on-scroll">
              ...
              <p class="text-gray-600 text-sm">最新功能，仅供测试</p>
            </div>
          </div>
...
const systemRequirements = [
  {
    ...
    icon: '🤖',
    version: 'Android 5.0+',
    notes: ['2GB RAM', '100MB 存储空间']
  },
  {
    platform: 'Windows',
    icon: '🪟',
    version: 'Windows 10+',
    notes: ['4GB RAM', '200MB 存储空间']
  },
  {
    platform: 'macOS',
    icon: '🍎',
