  ...
  <div class="space-y-8">
    ...
    <div v-if="loading" class="text-center py-12">
      <div class="inline-flex items-center justify-center w-12 h-12 mb-4">
        <div class="w-8 h-8 border-2 border-primary-200 border-t-primary-600 rounded-full animate-spin"/>
      </div>
      ...
      <div class="mb-8">
        ...
        <div class="sm:hidden">
          ...
          <div class="flex justify-between items-center">
            <div v-if="versions.length > 0" class="text-sm text-gray-500">
              共 {{ versions.length }} 个版本
            </div>
            <button
                @click="refresh"
                :disabled="refreshing"
                class="btn-apple bg-transparent border-gray-300 text-gray-700 hover:bg-gray-50 disabled:opacity-50 text-sm px-3 py-1.5"
            >
              <svg
